    ...
    class CryptoFileCipherAuto
    {
        ...
        static int Main(string[] args)
        {
            ...
            {         
                ...
                agent.SetMetadata(Agent.MetaApplicationName, "CryptoFileCipherAuto Sample");
            ...
            AutoFileCipher cipher = new AutoFileCipher(agent);
            ...
            {
                Console.WriteLine("Auto file cipher encrypt error: " + sdkExp.Message);
                WaitForInput();
                Environment.Exit(1);
            }
            ...
            {
                Console.WriteLine("Auto file cipher decrypt error: " + sdkExp.Message);
                WaitForInput();
                Environment.Exit(1);
            }
