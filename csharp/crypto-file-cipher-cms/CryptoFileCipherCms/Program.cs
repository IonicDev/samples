    ...
    class CryptoFileCipherCms
    {
        ...
        static int Main(string[] args)
        {
            ...
            {         
                ...
                agent.SetMetadata(Agent.MetaApplicationName, "CryptoFileCipherCms Sample");
            ...
            // Initialize CMS file cipher object.
            CmsFileCipher cipher = new CmsFileCipher(agent);
            ...
            {
                ErrorExitWithMessage("CMS file cipher encrypt error: " + sdkExp.Message);
            }
            ...
            {
                ErrorExitWithMessage("CMS file cipher decrypt error: " + sdkExp.Message);
            }
