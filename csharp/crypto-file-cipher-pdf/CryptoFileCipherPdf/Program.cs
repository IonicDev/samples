...
namespace Samples
{
    class CryptoFileCipherPdf
    {
        ...
        static int Main(string[] args)
        {
            ...
            string fileOriginal   = "../../../../../../sample-data/files/Message.pdf";
            string fileCipherText = "./Message-Protected.pdf";
            string filePlainText  = "./Message.pdf";
            ...
            {         
                ...
                agent.SetMetadata(Agent.MetaApplicationName, "CryptoFileCipherPdf Sample");
            ...
            PdfFileCipher cipher = new PdfFileCipher(agent);
